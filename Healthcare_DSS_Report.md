...
**مسئله اصلی**: سیستم‌های بهداشتی امروز با چالش یکپارچه‌سازی داده‌های متنوع و ارائه پشتیبانی تصمیم‌گیری مناسب برای نقش‌های مختلف مواجه هستند. سیستم‌های پشتیبانی تصمیم‌گیری[^1] موجود اغلب:
...
کتاب «تحلیل‌ها، علم داده و هوش مصنوعی: سیستم‌های پشتیبانی تصمیم‌گیری»[^3] نوشته توربان[^4]، شاردا و دلن چارچوب جامعی برای طراحی و پیاده‌سازی سیستم‌های پشتیبانی تصمیم‌گیری ارائه می‌دهد. این چارچوب بر اساس مدل چهار مرحله‌ای هربرت سایمون[^5] شامل مراحل هوشمندی، طراحی، انتخاب و پیاده‌سازی است.

در این پروژه، یک سیستم پشتیبانی تصمیم‌گیری جامع برای مراقبت‌های بهداشتی[^2] پیاده‌سازی شده است که از چهار زیرسیستم اصلی تشکیل شده: مدیریت داده‌ها[^6]، مدیریت مدل‌ها[^7]، مدیریت دانش[^8] و رابط کاربری[^9]. سیستم با استفاده از الگوریتم‌های یادگیری ماشین[^10] مختلف شامل جنگل تصادفی[^11]، تقویت گرادیان شدید[^12]، تقویت گرادیان سبک[^13] و ماشین بردار پشتیبان[^14]، قابلیت تحلیل و پیش‌بینی در حوزه‌های مختلف بهداشتی را فراهم می‌آورد.
...
- پیاده‌سازی ۸ الگوریتم یادگیری ماشین[^10] شامل جنگل تصادفی[^11]، تقویت گرادیان شدید[^12]، تقویت گرادیان سبک[^13]، ماشین بردار پشتیبان[^14]، رگرسیون لجستیک[^16]، رگرسیون خطی[^17]، درخت تصمیم[^18] و بیز ساده[^19]
...
[^2]: Healthcare
[^3]: Turban, E., Sharda, R., & Delen, D. (2020). Analytics, Data Science, & Artificial Intelligence: Systems for Decision Support (11th Edition). Pearson
[^4]: Turban
[^5]: Herbert Simon's Four-Phase Decision Model
[^6]: Data Management Subsystem
[^7]: Model Management Subsystem
[^8]: Knowledge Management Subsystem
